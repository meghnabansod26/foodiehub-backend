...
import com.meghna.foodiehub.entity.FoodEntity;
import com.meghna.foodiehub.io.FoodRequest;
import com.meghna.foodiehub.io.FoodResponse;
import com.meghna.foodiehub.repository.FoodRepository;
...
public class FoodServiceImpl implements FoodService{
    ...
    public String uploadFile(MultipartFile file) {
        ...
        try{
            ...
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "An error occured while uploading teh file");
    ...
    public FoodResponse addFood(FoodRequest request, MultipartFile file) {
        FoodEntity newFoodEntity = covertToEntity(request);
